...
public class Main {
    ...
    public static String verificarComboCompleto(String[] servicosContratados) {
        ...
        for (String servico : servicosContratados) {
            servico = servico.trim().toLowerCase(); // Remover espaços e padronizar para minúsculas

            // Verificando se os serviços foram contratados
    ...
    public static void main(String[] args) {
        ...
        // Entrada do usuário para os serviços contratados
